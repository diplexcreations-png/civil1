      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-24 right-6 z-50 w-[380px] h-[520px] max-w-[calc(100vw-2rem)] bg-white/95 dark:bg-[#090F1C]/95 border border-slate-200 dark:border-slate-800 rounded-3xl shadow-2xl backdrop-blur-md flex flex-col overflow-hidden text-left"
          >
            {/* Header */}
